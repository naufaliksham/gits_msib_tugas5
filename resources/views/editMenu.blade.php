...
<body>
    ...
    <form action="{{ url('updateMenu', $menu->id) }}" method="post" class="rounded-lg bg-[#111827] p-[2%] m-[5%]">
        {{ csrf_field() }}
        <h1 class="text-white text-center text-xl-center text-4xl mb-4">Edit Menu</h1>
        <div class="mb-6">
            <label for="name"
        ...
        <a href="{{ '/beranda' }}" class="text-white text-sm w-full sm:w-auto px-5 py-2.5">Back</a>
    </form>
